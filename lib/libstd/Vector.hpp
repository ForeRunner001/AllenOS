...
class Vector : public Sequence<T> {
 public:
     ...
     * If an item exists at the given position, it will be replaced by the given
     * item.
     *
    ...
    /**
     * Return the maximum size of this Vector.
     *
    ...
    /**
     * Return the number of items inside the Vector.
     *
     ...
     * Resize the Vector.
     *
     * @param increase Size to add the Vector.
     */
